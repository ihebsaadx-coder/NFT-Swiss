    ...
    useEffect(() => {
        const init = async () => {
            try {
                ...
                window.alert('Metmask is installed in your browser ! Please connect your wallet.');
                history.push("/");
            }
        }
        init();
                        ...
                        <div className="row">
                            ...
                            <div className="col-12">
                                <div className="sign__file">
                                    <label id="file1" htmlFor="sign__file-upload">Select Image (File types supported: JPG, PNG, GIF, SVG, WEBM,. Max size: 100 MB)</label>
